...
void app_main()
{
    ...
    esp_rmaker_param_t *yellow_param = esp_rmaker_param_create("Yellow", NULL, esp_rmaker_bool(false), PROP_FLAG_READ | PROP_FLAG_WRITE);
    esp_rmaker_param_add_ui_type(yellow_param, ESP_RMAKER_UI_TOGGLE);
    esp_rmaker_device_add_param(gpio_device, yellow_param);
