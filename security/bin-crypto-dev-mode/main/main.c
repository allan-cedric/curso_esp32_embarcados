...
void save_sensitive_data_to_nvs()
{
    ...
    const char *jwt_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ998...";
...
void app_main(void)
{
    ...
    read_fatfs_file("/fatfs/senha.txt");
    read_fatfs_file("/fatfs/aws_cert.pem");
    read_fatfs_file("/fatfs/aws_pkey.pem");
    read_fatfs_file("/fatfs/config.jsn");
    read_fatfs_file("/fatfs/tokens.txt");
    read_fatfs_file("/fatfs/bd_cli.db");
