...
* This example shows how to connect to a MQTT broker and publish messages to a topic
...
void app_main(void)
{
    ...
    while(1)
    {
        ...
        mqtt_app_publish("esp32/temperature",temperature_str,1,1);          //publish message "25" to topic "esp32/temperature" with qos 0 and retain 0
