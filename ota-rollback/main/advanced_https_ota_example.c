...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "  Type: %d", running_partition->type);
    ESP_LOGI(TAG, "  Subtype: %d", running_partition->subtype);
    ESP_LOGI(TAG, "  Address: %li", running_partition->address);
    ESP_LOGI(TAG, "  Size: %libytes", running_partition->size);
    ESP_LOGI(TAG, "  Label: %s", running_partition->label);
    ESP_LOGI(TAG, "  Encrypted: %s", running_partition->encrypted ? "true" : "false");
    ESP_LOGI(TAG, "  Read-only: %s", running_partition->readonly ? "true" : "false");
    ...
    */
    ...
    xTaskCreate(&blink_led_task, "blink_led_task", 10, NULL, 5, NULL);
